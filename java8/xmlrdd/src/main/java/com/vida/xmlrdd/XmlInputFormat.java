...
//        throw new RuntimeException("Error! XML start and end tags unspecified!");
      ...
      startTag = "<page".getBytes();//jobConf.get(START_TAG_KEY).getBytes("utf-8");
      endTag = "</page>".getBytes();//jobConf.get(END_TAG_KEY).getBytes("utf-8");
      ...
      System.out.println("Entering XML Record Reader");
      ...
      if (codec != null) {
        ...
        cin = codec.createInputStream(fs.open(file));
        fsin = new DataInputStream(cin);
    ...
    public boolean next(LongWritable key, Text value) throws IOException {
      if (pos % 100 == 18) {
        ...
        if (cin != null) {
          //System.out.println("compressed: " + cin.getPos());
        }
      }
      if (pos < end) {
